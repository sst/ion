...
description: "We are working on a new version of SST, called Ion, that’s not based on CDK. In this post we’ll talk about why we are moving away from CDK and what’s going to change."
template: splash
author: jay
