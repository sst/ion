...
- <p><code class="key">args</code> <code class="primitive">Omit</code><code class="symbol">&lt;</code>[<code class="type">CognitoIdentityProviderArgs</code>](/docs/component/aws/cognito-identity-provider/#cognitoidentityproviderargs), <code class="symbol">&ldquo;</code><code class="primitive">userPool</code><code class="symbol">&rdquo;</code><code class="symbol">&gt;</code></p>
