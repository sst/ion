...
function renderType(
  ...
  function renderSstComponentType(type: TypeDoc.ReferenceType) {
    ...
    const externalModule = {
      ...
      KinesisLambdaSubscriber: "kinesis-lambda-subscriber",
...
async function buildComponents() {
  ...
  const app = await TypeDoc.Application.bootstrap({
    ...
    entryPoints: [
      ...
      "../pkg/platform/src/components/aws/kinesis.ts",
      "../pkg/platform/src/components/aws/kinesis-lambda-subscriber.ts",
